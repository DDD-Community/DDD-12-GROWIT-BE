...
public class ToDoDBMapper {
  public ToDoEntity toEntity(ToDo todo) {
    ToDoEntity.ToDoEntityBuilder builder =
        ToDoEntity.builder()
            .uid(todo.getId())
  ...
  public ToDo toDomain(ToDoEntity entity) {
    ...
    if (entity.getRoutineStartDate() != null
        && entity.getRoutineEndDate() != null
        && entity.getRoutineRepeatType() != null) {
      RoutineDuration duration =
          RoutineDuration.of(entity.getRoutineStartDate(), entity.getRoutineEndDate());
