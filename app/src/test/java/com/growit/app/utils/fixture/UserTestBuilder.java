...
public class UserTestBuilder {
  ...
  public UserTestBuilder jobRoleId(String jobRoleId) {
    this.jobRoleId = jobRoleId;
    return this;
  }

  public UserTestBuilder careerYear(CareerYear careerYear) {
    this.careerYear = careerYear;
    return this;
  }

  public UserTestBuilder requiredConsent(RequiredConsent requiredConsent) {
