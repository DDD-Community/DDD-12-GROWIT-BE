...
class GetChatAdviceByGoalUseCaseTest {
  ...
  @InjectMocks private GetChatAdviceByGoalUseCase getChatAdviceByGoalUseCase;

  @Test
  @DisplayName("목표별 조언 조회 시 reset 체크 로직이 호출되어야 한다")
  void givenUserAndAdvice_whenExecute_thenResetDailyLimitShouldBeCalled() {
    ...
    // when
    getChatAdviceByGoalUseCase.execute(user, 1, "goal-1");
